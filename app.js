const banks = {
  moa: [
    ['p','塞音'],['b','塞音'],['t','塞音'],['d','塞音'],['k','塞音'],['ɡ','塞音'],['m','鼻音'],['n','鼻音'],['ŋ','鼻音'],['f','擦音'],['v','擦音'],['s','擦音'],['z','擦音'],['ʃ','擦音'],['h','擦音'],['l','邊近音'],['ɹ','近音'],['j','近音'],['w','近音'],['tʃ','塞擦音'],['dʒ','塞擦音']
  ],
  poa: [
...
const labels={moa:'MOA・發音方法',poa:'POA・發音部位',vowel:'Vowel・元音位置'};
